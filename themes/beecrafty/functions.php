...
function beecrafty_load_scripts() {
 if(is_home()) {
    ...
    wp_register_script( 'boxes', CHILD_URL.'/js/boxes.js');
    wp_enqueue_script( 'boxes' );
 }
}
...
function beecrafty_add_gallery_settings_box() {
    ...
    add_meta_box('genesis-theme-settings-home-gallery', __('Home Page  Gallery     Settings', 'beecrafty'),  'beecrafty_theme_settings_home_gallery',     'toplevel_page_genesis',  'column2');
    }
