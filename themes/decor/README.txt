<strong>DECOR CHILD THEME</strong>
<a href="http://www.studiopress.com/themes/decor">http://www.studiopress.com/themes/decor</a>

<strong>INSTALL</strong>
1. Upload the Decor child theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Decor theme.
...
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Decor child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Decor child theme demo site.

post-image - 730px by 285px
